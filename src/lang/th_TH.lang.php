 ...
 * PHP Server Monitor
 * ตรวจสอบเซิร์ฟเวอร์และเว็บไซต์ของคุณ
 *
 * ไฟล์นี้เป็นส่วนหนึ่งของ PHP Server Monitor
 * PHP Server Monitor เป็นซอฟต์แวร์ฟรี: คุณสามารถเผยแพร่ซ้ำและ/หรือแก้ไข
 * ได้ภายใต้เงื่อนไขของใบอนุญาตสาธารณะทั่วไป GNU ซึ่งเผยแพร่โดย
 * มูลนิธิซอฟต์แวร์เสรี ไม่ว่าจะเป็นใบอนุญาตเวอร์ชัน 3 หรือ
 * (ตามตัวเลือกของคุณ) เวอร์ชันที่ใหม่กว่า
 *
 * PHP Server Monitor เผยแพร่ด้วยความหวังว่าจะเป็นประโยชน์
 * แต่ไม่มีการรับประกันใดๆ ทั้งสิ้น ไม่แม้แต่การรับประกันโดยนัยว่า
 * สามารถขายได้หรือเหมาะสมสำหรับจุดประสงค์เฉพาะ ดู
 * ใบอนุญาตสาธารณะทั่วไป GNU สำหรับรายละเอียดเพิ่มเติม
 *
 * คุณควรได้รับสำเนาใบอนุญาตสาธารณะทั่วไป GNU
 * พร้อมกับ PHP Server Monitor หากไม่ได้รับ โปรดดูที่ <http://www.gnu.org/licenses/>
 *
